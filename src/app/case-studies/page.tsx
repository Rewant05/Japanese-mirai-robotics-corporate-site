...
export default function CaseStudiesPage() {
  ...
  const showParticles = useDesktopMotion(768);
  ...
  const cases = [
    {
      ...
      product: "やすらぎ（移乗補助アーム）",
      tag: "介護老人福祉施設",
      tagColor: "bg-medical-blue",
      excerpt: "慢性的な人手不足とスタッフの腰痛問題に悩まされていました。「やすらぎ」導入後、移乗介助の身体的負担がほぼゼロになり、離職率の大幅な改善に繋がっています。",
    ...
    <div className="bg-white min-h-screen">
      ...
      <section className="relative bg-dark-navy py-24 px-4 sm:px-6 lg:px-8 text-center overflow-hidden">
        ...
        <div ref={titleRef} className="relative z-10">
          ...
          <p className="text-soft-teal font-semibold tracking-widest">現場から届いた声</p>
        </div>
      </section>
