  ...
  return (
    <div className="bg-white">
      ...
      <section className="bg-mist-blue py-20 px-4 sm:px-6 lg:px-8 text-center border-b border-gray-200">
        ...
        <p className="text-soft-teal font-semibold tracking-widest">会社概要</p>
      </section>
      ...
      <section className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-gray-600 leading-relaxed text-left md:text-center">
            私たちは、少子高齢化という社会課題に対し、最先端のロボティクスと人工知能技術で応えます。<br />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mt-16">
          <div className="text-center">
            ...
            <h3 className="text-xl font-bold mb-4 text-dark-navy">使命</h3>
          ...
          <div className="text-center">
            ...
            <h3 className="text-xl font-bold mb-4 text-dark-navy">展望</h3>
          ...
          <div className="text-center">
            ...
            <h3 className="text-xl font-bold mb-4 text-dark-navy">大切にする価値</h3>
