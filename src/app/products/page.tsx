...
export const metadata = {
  ...
  description: "HIKARI、MAMORI、YASURAGIなど、最先端の介護ロボット製品ラインナップをご紹介します。",
};
  ...
  return (
    <div className="bg-white">
      <section className="bg-mist-blue py-20 px-4 sm:px-6 lg:px-8 text-center border-b border-gray-200">
        ...
        <p className="text-soft-teal font-semibold tracking-widest uppercase">Products</p>
      </section>
        ...
        <div id="hikari" className="scroll-mt-32">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="order-2 lg:order-1 bg-blue-50 rounded-3xl p-12 h-96 flex flex-col items-center justify-center relative overflow-hidden group">
               ...
               <div className="mt-8 text-center font-mono text-medical-blue tracking-widest opacity-50">HIKARI - WALKING ASSIST</div>
            </div>
            <div className="order-1 lg:order-2">
              <span className="text-medical-blue font-semibold text-sm">歩行支援ロボット</span>
              <h2 className="text-3xl md:text-5xl font-bold text-dark-navy mt-2 mb-6">HIKARI</h2>
              <p className="text-gray-600 text-lg leading-relaxed mb-8">
                高齢者の歩行を優しく、力強くサポートするウェアラブルデバイス。
                独自のAIアルゴリズムが歩行パターンを瞬時に学習し、一人ひとりに合わせた最適なアシスト力を提供します。
              </p>
        ...
        <div id="mamori" className="scroll-mt-32">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="text-3xl md:text-5xl font-bold text-dark-navy mt-2 mb-6">MAMORI</h2>
              <p className="text-gray-600 text-lg leading-relaxed mb-8">
            ...
            <div className="bg-teal-50 rounded-3xl p-12 h-96 flex flex-col items-center justify-center relative overflow-hidden group">
               ...
               <div className="mt-8 text-center font-mono text-soft-teal tracking-widest opacity-50">MAMORI - VITAL SENSOR</div>
            </div>
          </div>
        </div>
        ...
        <div id="yasuragi" className="scroll-mt-32">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="order-2 lg:order-1 bg-purple-50 rounded-3xl p-12 h-96 flex flex-col items-center justify-center relative overflow-hidden group">
               ...
               <div className="mt-8 text-center font-mono text-purple-600 tracking-widest opacity-50">YASURAGI - TRANSFER ASSIST</div>
            </div>
            <div className="order-1 lg:order-2">
              <span className="text-purple-600 font-semibold text-sm">移乗補助アーム</span>
              <h2 className="text-3xl md:text-5xl font-bold text-dark-navy mt-2 mb-6">YASURAGI</h2>
              <p className="text-gray-600 text-lg leading-relaxed mb-8">
